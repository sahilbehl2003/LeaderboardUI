...
const App = () => {
  ...
  return (
    <>
      <header className='font-googleSans flex justify-center items-center absolute w-full top-8 z-10'>
  ...
  {tableData.slice(0, 3).map((entry, index) => (
    ...
    >
      ...
      <div className="p-4 text-left w-full">
        ...
        {filteredEntry ? (
          <div className="absolute left-1/2 transform -translate-x-1/2 bg-green-100 py-3 rounded-lg px-4 mt-8" style={{ borderRadius: '20px' }}>
            <div className="flex items-center justify-between">
              <div className="text-lg font-bold bg-dark-green-500 text-white px-3 py-1" style={{ backgroundColor: '#00AC4F', height: '60px', width: '80px', borderRadius: '20px', textAlign: 'center' }}>
                <div style={{ marginTop: '12px' }}>
                  {filteredEntry.index}{getOrdinalSuffix(filteredEntry.index)}
                </div>
              </div>
              <div className="flex items-center">
                <div className="text-lg" style={{ marginRight: '20px' }}>{filteredEntry.territory_id}</div>
                <div className="flex items-center">
                  <img src="icon 2.png" alt="Points Icon" className="w-4 h-4" />
                  <div className="text-lg" style={{ marginLeft: '10px' }}>{filteredEntry.total_points}</div>
                </div>
              </div>
            </div>
          </div>
